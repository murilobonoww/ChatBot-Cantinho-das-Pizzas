...
prompt_template = [{
    ...
    "content": (
        ...
        "Se o cliente quiser uma pizza de dois sabores (meio a meio / metade sabor x e metade sabor y), eu devo comparar os valores da pizza sabor x e da pizza sabor y, e o preço da pizza meio a meio será o preço da pizza mais cara entre o sabor x e o sabor y."
        f"{fetch_pizzas()}"
